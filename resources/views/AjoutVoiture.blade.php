                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text"  class="form-control form-control-alternative" placeholder="Model" name="Model">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text"  class="form-control form-control-alternative" placeholder="Carburant" name="Carburant">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" >Boite à vitesse</label>
                        <input type="text"  class="form-control form-control-alternative" placeholder="Boite à vitesse" name="BoiteVitesse">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" >Puissance</label>
                        <input type="text"  class="form-control form-control-alternative" placeholder="CV" name="Puissance">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" >Prix</label>
                        <input type="number"  class="form-control form-control-alternative" placeholder="DH" name="Prix">
                      </div>
                    </div>
                  </div>
