...
">
  ...
  <div class="main-content">
    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row mt-5" style="margin-left:15% !important">
        <div width="80%" class="col-xl-8 mb-5 mb-xl-0" style="max-width: max-content !important;">
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
              @if( $categories->count()==0) 
                 <div class="col-12">
                  <h3 class="mb-0" style="margin-left: 28px;">Aucune categorie</h3>
                 </div>
              ...
              @else
                <div class="col">
                  <h3 class="mb-0" style="margin-left: 28px;">La liste des catégories</h3>
                </div>
                <div class="col text-right">
                  <a href="{{ route('AjoutCategorie') }}" class="btn btn-sm btn-primary">Ajouter</a>
                </div> 
                ...
                <div class="col text-right ml-2">
                  <form action="{{ route('searchC') }}" method="post" role="search">
                    {{ csrf_field() }}
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush" id="myTable">
                <thead class="thead-light">
                  <tr>
                            <th>Identifiant</th>
                            <th class="number">Libelle</th>
                            <th class="number">Nbr_Voiture
                            </th>
                ...
                @foreach($categories as $categorie)
                            <tr>
                                ...
                                <td> {{count ($categorie->Voitures)}}</td>
                                 <td >
                               
                                    <form action="{{ url('editCategorie/'.$categorie->id) }}" method="POST" style="display: inline;">
                                   ...
                                   <form action="{{ url('deleteCategorie/'.$categorie->id) }}" method="POST" style="display: inline;">
                                   <input type="hidden"  name="id" value="{{$categorie->id}}">
                                   {{ method_field('DELETE') }}
                                   {{ csrf_field() }}
          ...
          <div class="page-pagi">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination"> {{ $categories->onEachSide(1)->links() }}
