							...
							<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell" bgcolor="#f4f4f4">
								<tr>
									<td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; Margin:0">
										<div class="hide-for-mobile"><img src="{{asset('img/black.jpg')}}"  width="650" height="30" alt="" /></div>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; Margin:0" width="227">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="img" style="font-size:0pt; line-height:0pt; text-align:left"><div class="img-m-center" style="font-size:0pt; line-height:0pt"><a href="#" target="_blank"><img src="{{asset('img/images/logo_free.jpg')}}" border="0" width="227" height="47" alt="MailBakery Iota - Email Newsletter Template" /></a></div><div style="font-size:0pt; line-height:0pt;" class="mobile-br-15"></div>
</td>
																	</tr>
																</table>
															</th>
																	...
																	<tr>
																		<td align="right">
																			<table class="center" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td class="img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="{{asset('img/images/ico_facebook_yellow_black.jpg')}}" border="0" width="14" height="13" alt="" /></a></td>
																					<td class="img-center" style="font-size:0pt; line-height:0pt; text-align:center" width="30"><img src="{{asset('img/images/socials_yellow_black_separator.jpg')}}" border="0" width="5" height="8" alt="" /></td>
																					<td class="img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="{{asset('img/images/ico_twitter_yellow_black.jpg')}}" border="0" width="14" height="13" alt="" /></a></td>
																					<!--<td class="img-center" style="font-size:0pt; line-height:0pt; text-align:center" width="30"><img src="images/socials_yellow_black_separator.jpg" border="0" width="5" height="8" alt="" /></td>
																					 <td class="img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="images/ico_gplus_yellow_black.jpg" border="0" width="14" height="13" alt="" /></a></td>
																					<td class="img-center" style="font-size:0pt; line-height:0pt; text-align:center" width="30"><img src="images/socials_yellow_black_separator.jpg" border="0" width="5" height="8" alt="" /></td>
																					<td class="img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="images/ico_pinterest_yellow_black.jpg" border="0" width="14" height="13" alt="" /></a></td>
																					<td class="img-center" style="font-size:0pt; line-height:0pt; text-align:center" width="30"><img src="images/socials_yellow_black_separator.jpg" border="0" width="5" height="8" alt="" /></td>
																					<td class="img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="images/ico_instagram_yellow_black.jpg" border="0" width="14" height="13" alt="" /></a></td> -->
																				</tr>
																			</table>
																		</td>
																	</tr>
							...
							<td align="center">
								<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell" bgcolor="#f6de17">
									<tr>
										<td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; Margin:0">
											<!-- Full Width Image -->
											<div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left"><img src="{{asset('img/images/banner.jpg')}}" border="0" width="650" height="340" alt="" /></div>
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													...
													<td>
														...
														<div class="h2-black-center" style="color:#26252a; font-family:Arial,sans-serif, 'Roboto'; font-size:26px; line-height:32px; text-align:center; min-width:auto !important"><strong>MailBelgio Car</strong> </div>
                                                        ...
                                                        Bonjour,<br>
														Nous accusons réception de votre réservation et nous vous remercions de l'intérêt que vous portez à notre société.
Votre réservations sera traité dans le plus bref délais.
Nous vous prions d'agréer Madame ,Mademoiselle, Monsieur nos salutation les meilleurs.
											...
											<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell" bgcolor="#f6de17">
												<tr>
													<td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; Margin:0">
														...
														<div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left"><img src="{{asset('img/images/yellow_black_top_image.jpg')}}" style="display: block;" border="0" width="650" height="30" alt="" /></div>
													</td>
												</tr>
											</table>
										</td>
				...
				<!-- Section 2 -->
																...
																<!--				<table width="100%" border="0" cellspacing="0" cellpadding="0">
																					<tr>
																						<td>
																							<div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left"><img src="{{asset('img/images/two_columns2_image2.jpg')}}" border="0" width="290" height="180" alt="" /></div>
																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f4f4f4">
																								<tr>
																									...
																									<td>
																										...
																										<div class="text" style="color:#26252a; font-family:Arial,sans-serif, 'Roboto'; font-size:14px; line-height:21px; text-align:left; min-width:auto !important">Nam dignissim tincidunt tortor, eget dapibus nunc ultrices ac. Etiam aliquam id arcu quis aliquam. Sed a orci et neque varius varius ac sit amet odio ...</div>
																													...
																													<table bgcolor="#f6de17" border="0" cellspacing="0" cellpadding="0">
																														<tr>
																															...
																															<td>
																																...
																																<div class="text-button" style="color:#373737; font-family:Arial,sans-serif, 'Roboto'; font-size:12px; line-height:16px; text-align:left; font-weight:bold; text-transform:uppercase; min-width:auto !important"><a href="#" target="_blank" class="link-black" style="color:#26252a; text-decoration:none"><span class="link-black" style="color:#26252a; text-decoration:none">READ MORE</span></a></div>
																																<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="10" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
																				...
																				<div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left"><img src="{{asset('img/images/two_columns2_white_black.jpg')}}" border="0" width="290" height="10" alt="" /></div>
							...
							<td align="center">
								<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
									<tr>
										...
										<!-- Modifier la photo mettez le logo -->
											<div class="img-center" style="font-size:0pt; line-height:0pt; text-align:center"><a href="#" target="_blank"><img src="{{asset('img/images/logo_footer_center.png')}}" border="0" width="174" height="47" alt="MailBakery Iota - Email Newsletter Template" /></a></div>
											<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="25" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>

											
											<table border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td class="img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="{{asset('img/images/facebook.png')}}" border="0" width="10" height="20" alt="facebook" /></a></td>
													...
													<td class="img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="{{asset('img/images/twitter.png')}}" border="0" width="18" height="20" alt="twitter" /></a></td>
													<td class="text-2-c" style="color:#1f1e23; font-family:Arial,sans-serif, 'Roboto'; font-size:12px; line-height:16px; text-align:center; min-width:auto !important" width="27">/</td>
													<td class="img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="{{asset('img/images/google.png')}}" border="0" width="18" height="20" alt="google" /></a></td>
											...
											<div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left"><img src="{{asset('img/images/white_grey_top_image.jpg')}}" style="display: block;" border="0" width="650" height="55" alt="" /></div>
										</td>
									</tr>
								</table>
							</td>
												...
												<tr>
													...
													<td>
														<!-- <div class="text2-center-white" style="color:#ffffff; font-family:Arial,sans-serif, 'Roboto'; font-size:12px; line-height:20px; text-align:center; min-width:auto !important">
															You&rsquo;re receiving this newsletter because you bought template from us. <span class="hide-for-mobile"><br /></span>Not interested anymore? <a href="#" target="_blank" class="link-white-u" style="color:#ffffff; text-decoration:underline"><span class="link-white-u" style="color:#ffffff; text-decoration:underline">Unsubscribe</span></a> instantly.
														</div> -->
